...
V3 update: ปรับระบบ Cloud Sync ให้ไม่ reload iframe ระหว่างใช้งาน เพื่อลดอาการเลื่อนแล้วเด้งกลับบนสุด ข้อมูลจากอุปกรณ์อื่นจะโหลดตอนเปิดใหม่/refresh/sign in ใหม่
